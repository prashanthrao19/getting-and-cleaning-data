...
9. Combined the data frames to produce one data frame containing the subjects,activities and measurements
...
Please refer to [run_analysis.R] (https://github.com/prashanthrao19/getting-and-cleaning-data/blob/master/run_analysis.R) for implementation details.
